...
@section('content')
 ...
 <div class="card" style='width:80%; margin:auto;'>
    ...
    <div class="card-body list-group-container">
        <div>
            <h2><i class="fas fa-video" style='font-size:20px;'></i> Video </h2>
            ...
            <div class="upload-drop-zone" id="drop-zone">            
                <div class="form-group">
                    ...
                    <label for="video"><svg xmlns="#" width="20"  viewBox="0 0 20 17">
                        ...
                        </svg> <span>Επιλογή αρχείου…</span></label>
                </div>                      
            </div>
        ...
        <hr/>
        <div>
            <h2><i class="fas fa-bullhorn" style='font-size:20px;'></i> Ανακοίνωση </h2>
            <div class="md-form">
            ...
            <div class="md-form amber-textarea active-amber-textarea-2">
              ...
              <label for="announce-content">Περιεχομένο ανακοίνωσης</label>
            </div> 
            <div class='btn btn-primary' style='float:right;' id='btn-save-announce'><i class="fas fa-upload"></i>Αποθήκευση</div>   
        </div>
    </div>
</div>
