                        ...
                        <div class="classynav">
                            <ul id="nav" >
                                ...
                                <li>
                                  ...
                                  <ul class="dropdown">
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('partner.dashboard') }}">
                                          <i class="fas fa-tv text-primary"></i> Dashboard
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('partner.upload') }}">
                                        <i class="fas fa-upload text-orange"></i> Upload
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('partner.partnerappoint') }}">
                                        <i class="fas fa-calendar-check text-yellow"></i> Ραντεβού
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('partner.articles') }}">
                                        <i class="fas fa-newspaper text-red"></i> Άρθρα
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('partner.videos') }}">
                                        <i class="fas fa-video text-green"></i> Videos
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('partner.images') }}">
                                        <i class="fas fa-images text-blue"></i> Εικόνες
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('partner.promote') }}">
                                        <i class="fas fa-ad text-orange"></i> Παρουσίαση
                                      </a>
                                    </li>
                                  </ul>
                                </li>
