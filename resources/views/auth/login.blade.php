    ...
    <div class='circle-mall-section'>    
        ...
        <div class='row' style='margin:auto;'>
            <div class='col-md-6' id='service-latest-article' style='padding-left:5%; padding-right: 2%;'>                
                ...
                <p id='latest-article-text' style='text-align: left; word-wrap: break-word; margin-top:-10px;'>
                    <!-- Ως μέλος Diaskedazw μπορείς να απολαμβάνεις δωρεάν  εκδηλώσεις διασκέδασης και
                    υπηρεσίες που ενδιαφέρουν εσένα και την οικογένεια σου.--> Στόχος μας είναι να μειώσουμε το κόστος ζωής του ανθρώπου, παρέχοντας του όλα τα μέσα και τα εργαλεία που χρειάζεται, μέσα από το υπερσύγχρονο ΜΑLLYΠΗΡΕΣΙΩΝ της DIASKEDAZW, έτσι ώστε να ενώσουμε τους ανθρώπους σε ολόκληρο τον κόσμο.  Ανεξαρτήτως  χρώματος, εθνικότητας και πιστεύω για την μετάβαση όλων από το ΕΓΩ στο ΕΜΕΙΣ. Κάτι το οποίο μπορεί να φέρει το φως και την ελευθερία σε ολόκληρο τον κόσμο.  Έτσι όλοι μαζί μπορούμε να επιτύχουμε τους στόχους μας και να στηρίξουμε μαζί τον οποιονδήποτε συνάνθρωπο μας χρειάζεται πραγματικά βοήθεια.
                    <p>“H DIASKEDAZW ΕΙΝΑΙ ΜΙΑ ΕΠΑΝΑΣΤΑΤΙΚΗ ΙΔΕΑ,  
 ΠΟΥ ΣΤΟΧΕΥΕΙ ΝΑ ΔΩΣΕΙ ΛΥΣΕΙΣ ΣΤΗΝ ΠΑΓΚΟΣΜΙΑ ΑΓΟΡΑ,  
ΑΛΛΑ ΚΥΡΙΩΣ ΣΤΟΝ ΑΝΘΡΩΠΟ. ΜΕ ΕΝΑ ΠΡΩΤΟΠΟΡΙΑΚΟ ΤΡΟΠΟ ΑΝΑΠΤΥΞΗΣ ΚΑΙ ΜΕΣΩ 
ΜΙΑΣ ΤΕΡΑΣΤΙΑΣ ΗΛΕΚΤΡΟΝΙΚΗΣ ΠΛΑΤΦΟΡΜΑΣ, ΠΑΡΟΥΣΙΑΖΕΙ TO ΥΠΕΡΣΥΓΧΡΟΝΟ 
ONLINE MALL ΥΠΗΡΕΣΙΩΝ ΚΑΙ ΣΥΝΕΡΓΑΤΩΝ. 
ENAΣ ΧΩΡΟΣ Ο ΟΠΟΙΟΣ ΜΠΟΡΕΙ ΝΑ ΣΤΕΓΑΣΕΙ ΚΑΙ ΝΑ ΣΤΗΡΙΞΕΙ ΧΙΛΙΑΔΕΣ ΑΝΘΡΩΠΟΥΣ ΑΛΛΑ 
ΚΑΙ ΕΠΙΧΕΙΡΗΣΕΙΣ ΣΕ ΟΛΟΚΛΗΡΟ ΤΟΝ ΚΟΣΜΟ.  
Η DIASKEDAZW, ΜΕ ΕΝΑ ΔΥΝΑΜΙΚΟ ΠΛΑΝΟ ΑΝΑΠΤΥΞΗΣ, ΕΡΧΕΤΑΙ ΝΑ ΣΥΝΔΕΣΕΙ ΤΟ
 ΚΑΤΑΝΑΛΩΤΙΚΟ ΚΟΙΝΟ ΜΕ ΤΟΝ ΕΠΙΧΕΙΡΗΜΑΤΙΚΟ ΚΟΣΜΟ, ΜΕΣΩ ΜΙΑΣ ΚΑΙΝΟΤΟΜΙΑΣ:  

ΤΗΝ ΣΥΝΑΛΛΑΓΗ ΤΟΥ ΜΕΛΛΟΝΤΟΣ, ΤΟN ΕΛΛΗΝ.!!!”
</p>
