...
<script src="{{ asset( 'js/user-pages/partnerprofile/article/index.js') }}"></script>
@endpush
    ...
    <div class='mainarea'>    
        <div class='main-area-content'>
            <div class='row' style='width:100%; border-bottom: 1px solid #444;'>
                ...
                <div class='col-md-6'>
                    @include('user.component.searchbox')                    
                </div>
            </div>
            @include('user.partnerprofile.component.articleshow')
            @include('user.partnerprofile.component.article', ['count'=>'-1'])
