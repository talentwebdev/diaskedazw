                            ...
                            <ul id="nav" >
                                ...
                                <li>
                                  ...
                                  <ul class="dropdown">
                                    ...
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('admin.videos') }}">
                                        <i class="fas fa-video text-green"></i> Βίντεο
                                      </a>
                                    </li>                                    
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('admin.images') }}">
                                        <i class="fas fa-images text-blue"></i> Εικόνες
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('admin.checkvideos') }}">
                                        <i class="fas fa-video text-green"></i> Έλεγχος Βίντεο
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('admin.checkarticles') }}">
                                        <i class="fas fa-newspaper text-red"></i> Έλεγχος Άρθρων
                                      </a>
                                    </li>
                                    <li>
                                      <a class="nav-link waves-effect waves-light" href="{{ route('admin.checkimages') }}">
                                        <i class="fas fa-images text-blue"></i> Έλεγχος Εικόνων
                                      </a>
                                    </li>
                                  </ul>
                                </li>
